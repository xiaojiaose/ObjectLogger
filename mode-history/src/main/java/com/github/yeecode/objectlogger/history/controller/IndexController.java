...
public class IndexController {
    ...
    public String index() {
        return "<div>\n" +
                ...
                "\t<br/>\n" +
                "\t<code>http://localhost:12301/logger/log/query</code> <a href=\"/logger/log/query\" target=\"_blank\"><button>Try It</button></a>\n" +
                "\t<br/>\n" +
                "</div>\n" +
                "<br/>\n" +
                "<br/>\n" +
                ...
                "\tFor example:\n" +
                "\t<br>\n" +
                "\t<code>http://localhost:12301/logger/log/query?appName=demo&objectName=CleanRoomTask&objectId=5</code>\n" +
                "\t<a href=\"/logger/log/query?appName=ObjectLoggerDemo&objectName=CleanRoomTask&objectId=5\" target=\"_blank\"><button>Try It</button></a>\n" +
                "</div>\n" +
                "</div>";
    }
}
